...
#define TCG_TARGET_HAS_mul_vec          (TCG_TARGET_HAS_ZVE_VECTOR | TCG_TARGET_HAS_XTHEAD_VECTOR)
#define TCG_TARGET_HAS_sat_vec          (TCG_TARGET_HAS_ZVE_VECTOR | TCG_TARGET_HAS_XTHEAD_VECTOR)
#define TCG_TARGET_HAS_minmax_vec       (TCG_TARGET_HAS_ZVE_VECTOR | TCG_TARGET_HAS_XTHEAD_VECTOR)
